package com.zzp.maker.template;
...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        String projectPath = System.getProperty("user.dir");
        String originProjectPath = new File(projectPath).getParent() + File.separator + "zzp-generator-demo-projects/acm-template-pro";
        String inputFilePath = "src/main/java/com/zzp/acm/MainTemplate.java";
        // 1. 构建配置参数
        Meta meta = new Meta();
...
//        String searchStr = "Sum: ";
        // 替换变量（第二次）
        String
                searchStr = "MainTemplate";

        long id = makeTemplate(meta, originProjectPath, inputFilePath, modelInfo, searchStr, 1814216985892323328L);
